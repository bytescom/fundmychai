...
export default async function ProfileHeader({ username }) {
  const profile = {
    name: username ? (username.charAt(0).toUpperCase() + username.slice(1)) : "Creator",
    bio: "Building cool things on the internet. Support my work by buying a chai!",
    supporters: 42,
    joinedDate: "Jun 2026",
    location: "Mumbai, India",
    coverImage: "bg-gradient-to-br from-orange-400 via-orange-300 to-amber-200",
